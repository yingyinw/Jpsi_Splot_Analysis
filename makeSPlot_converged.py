...
MAX_EVENTS = 10000000  # increase after stable convergence
#MAX_EVENTS = 5000000
...
cbAlphaL.setVal(3.4359237)
cbAlphaR.setVal(0.23133838)
chebP1.setVal(-0.63658224)
chebP2.setVal(-0.0080077985)
chebP3.setVal(0.027079298)
ctBkg_mean.setVal(0.00016333931)
ctBkg_sig1.setVal(0.001460148)
ctBkg_sig2.setVal(0.0036000078)
ctBkg_tau_right.setVal(0.038443121)
ctNonPrompt_tau.setVal(0.037031496)
gSigma1.setVal(0.040502205)
gSigma2.setVal(0.020926437)
mean.setVal(3.0946858)

for p in [
    cbSigmaL,cbSigmaR, cbNL, cbNR,
    fracG1, fracCB1, fracGaussInSig,
    ctRes_mean, 
    ctRes_sig1, ctRes_sig2, ctRes_sig3,
...
gSigma1.setConstant(ROOT.kFALSE)
gSigma2.setConstant(ROOT.kFALSE)
cbAlphaL.setConstant(ROOT.kFALSE)
cbAlphaR.setConstant(ROOT.kFALSE)
chebP1.setConstant(ROOT.kFALSE)
chebP2.setConstant(ROOT.kFALSE)
chebP3.setConstant(ROOT.kFALSE)
ctNonPrompt_tau.setConstant(ROOT.kFALSE)
ctBkg_mean.setConstant(ROOT.kFALSE)
ctBkg_sig1.setConstant(ROOT.kFALSE)
ctBkg_sig2.setConstant(ROOT.kFALSE)
ctBkg_tau_right.setConstant(ROOT.kFALSE)
...
# ================================================================
output_file = ROOT.TFile("fitOutput_final.root", "RECREATE")
